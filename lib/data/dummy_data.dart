...
const availableCategories = [
  ...
  Category(id: 'c8', title: 'Lunch', color: Colors.grey),
  Category(id: 'c9', title: 'South India', color: Colors.lightGreenAccent),
  Category(id: 'c10', title: 'North India', color: Colors.indigoAccent),
];
